...
class EndPointsControllerTest < ActionController::TestCase
  ...
  test "should create end_point" do
    assert_difference('EndPoint.count') do
      post :create, end_point: { change_set: @end_point.change_set, environment: @end_point.environment, specification: @end_point.specification, url: @end_point.url }
    end
  ...
  test "should update end_point" do
    put :update, id: @end_point, end_point: { change_set: @end_point.change_set, environment: @end_point.environment, specification: @end_point.specification, url: @end_point.url }
    assert_redirected_to end_point_path(assigns(:end_point))
  end
